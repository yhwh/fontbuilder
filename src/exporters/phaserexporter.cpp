#include "phaserexporter.h"
#include "../fontconfig.h"

PhaserExporter::PhaserExporter(QObject *parent) :
    AbstractExporter(parent)
{
    setExtension("xml");
}

bool PhaserExporter::Export(QByteArray &out)
{
    // Format description:
    // http://www.angelcode.com/products/bmfont/doc/file_format.html

    const FontConfig* cfg = fontConfig();
    out.append(QString("<?xml version=\"1.0\"?>")).append('\n');
    out.append(QString("<font>")).append('\n');
    ...
    out.append(QString("<pages>")).append('\n');
    ...
    out.append(QString("<chars>")).append('\n');
    ...
    out.append(QString("<kernings>")).append('\n');
    foreach(const Symbol& c , symbols()) {
...
AbstractExporter* PhaserExporterFactoryFunc (QObject* parent) {
    return new PhaserExporter(parent);
}
